...
For those interested in setting up the bosh environment manually, I provide an additional tutorial (see [Manual Deployment](docs/MANUAL.md)).
...
For the impatient I prepared a [quick start guide](docs/QUICKSTART.md).
